...
class TopBar extends React.Component {
    ...
    if(ison){pro_drop.style.display="none"
    ar.style.transform="rotateZ(0deg)"


            ison = false} 
            
            else { pro_drop.style.display="block"
    ...
    render() {
        ...
        return (
            ...
            <div className="top_bar" style={margin}>
                ...
                <li className="top_btns profile_btn" >Hello , Tushar <span><img id="arrow" src={arrow} alt="?" /></span> </li>
