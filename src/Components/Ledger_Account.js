            ...
            <div className="ledger_tab">
                ...
                <br />
                    ...
                    <div className = "checkboxes_search">
                         <input type="radio" name="parti" id = "check_parti" value = "A" onClick = {() => {
                             this.props.handleradio('parti')
                         }} />
                        <label for="A">Particulars</label>
                        <input type="radio" name="parti" id = "check_agent" value = "B" onClick = {() => {
                            this.props.handleradio('agent')
                        }} />
                        <label for="B">Sub Agent</label>
                        <input type="radio" name="parti" id = "check_bill_num" value = "C" onClick = {() => {
                            this.props.handleradio('bill_num')
                        }} />
                        <label for="C">Bill No.</label>
                    
                    </div>
                    <input type="search" placeholder = "Search" id = "specific_search_ledger" 
                    onKeyPress={this.enterPressed.bind(this)} />
                    </div>

                    <div className = "search_date">
                        <button onClick={this.props.getDet} className = "btn_search">search</button>
                    </div>

                        <button onClick = {this.props.clearall} className = "btn_search" >clear filters</button>

                        <button onClick = {this.handleModal} className = "btn_search">Print ledger</button>
                </div>
