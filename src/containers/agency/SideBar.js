    ...
    return (
      <div className="side_bar">
        <div className="side_bar_con">
          ...
          <li
            className={location.pathname==="/agency/accountings"? "side_btn act_s_btn" : "side_btn"}
          >
          ...
          <li
            className={location.pathname==="/agency/transactions" ? "side_btn act_s_btn" : "side_btn"}
          >
          ...
          <li
            className={location.pathname==="/agency/agency" ? "side_btn act_s_btn" : "side_btn"}
          >
          ...
          <li
            className={location.pathname==="/agency/trash" ? "side_btn act_s_btn" : "side_btn"}
          >
