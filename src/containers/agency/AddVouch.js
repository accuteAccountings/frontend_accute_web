...
class AddVouch extends React.Component {
	...
	setData = () => {
		...
		document.querySelector("#vouch_transport_name").defaultValue =
			d.transport_name;
		...
		if (d.supplier_agent2) {
			...
			setTimeout(() => {
				document.querySelector("#vouch_sup_agent2").defaultValue =
					d.supplier_agent2;
			}, 500);
		}
	...
	async addVouch() {
		...
		let newSupplier = await this.CreateNewSupplier();
		let newCustomer = await this.CreateNewCustomer();
	...
	CreateNewSupplier = () => {
		...
		return postData("/api/accounts", data, "POST");
	};
	CreateNewTransport = () => {
                      ...
                      <MenuItem value="dn">Debit</MenuItem>
									...
									<div className="vouch_si">
										...
										<input
											onBlur={() => {
												if (
													document.getElementById("vouch_bill_no").value !== ""
												) {
													this.rmEnterError("vouch_bill_no");
												}
											}}
									...
									<div className="vouch_si">
										...
										<input
											...
											onChange={(e) =>
												this.setState({ l_r_date: e.target.value })
											}
										/>
									</div>
									...
									<div className="vouch_si vouch_sup_con">
										...
										<input
											...
											onBlur={() => {
												...
												setTimeout(() => {
													document.getElementById("sup_list").style.display =
														"none";
												}, 500);
											}}
											name="vouch_sup"
										...
										<ul id="sup_list">
											{this.state.acc.map((acc, index) => {
												if (
													(acc.acc_type !== "debtors" &&
														acc.acc_type !== "creditors") ||
                      ...
                      <option value={null}>None</option>
									...
									<div className="vouch_si">
										...
										<input
											...
											defaultValue={
												this.props.mode === "edit"
													? this.props.EData.det.set_commission
													: "1"
											}
										/>
									</div>
									<div id="gst_con" className="vouch_si">
										...
										<input
											...
											onBlur={() => {
												...
												this.setState({
													gst: document.getElementById("vouch_gst").value,
												});
												this.updateTotal();
											}}
										/>
									...
									{this.state.subAgent ? (
										<div className="vouch_si vouch_sub_agnent_con">
											...
											<input
												...
												onBlur={() => {
													if (
														document.getElementById("vouch_sup_agent2")
															.value !== ""
													) {
													}
													setTimeout(() => {
														...
														if (
															...
															let data = {
																acc_name: document.getElementById(
																	"vouch_sup_agent2"
																).value,
																acc_type: "Sub Agent",
															};
						...
						<div className="vouch_body_middle">
							<div className="vouch_si" id="vouch_pro_con">
								...
								<input
									...
									onBlur={() => {
										setTimeout(() => {
											document.getElementById("pro_list").style.display =
												"none";
										}, 500);
									}}
								/>
									...
									{this.state.pro.map((pro, index) => {
										...
										return (
											<li
												key={index}
												onClick={() => {
													document.getElementById("vouch_pro_item").value =
														pro.product_name;
													document.getElementById("vouch_hsn_num").value =
														pro.hsn_num;
													document.getElementById("pro_list").style.display =
							...
							<div className="vouch_si">
								...
								<input
									...
									onChange={(e) => {
										if (
											e.target.value >= 0 &&
											document.getElementById("vouch_rate").value
										) {
											document.getElementById("vouch_amount").value =
												parseFloat(e.target.value) *
												parseFloat(document.getElementById("vouch_rate").value);
										}
									}}
									type="number"
									name="vouch_quantity"
							...
							<div className="vouch_si">
								...
								<input
									...
									onChange={(e) => {
										if (
											e.target.value >= 0 &&
											document.getElementById("vouch_quantity").value
										) {
											document.getElementById("vouch_amount").value =
												parseFloat(e.target.value) *
												parseFloat(
					...
					<div className="vouch_body_right">
						<table className="vouch_num_items">
							<tr>
								...
								<td className="bold">
									<strong>
										₹{this.roundOffTheNumber(this.state.grossAmt)}
									</strong>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td className="bold">
									<strong>
										₹
										{this.roundOffTheNumber(
											this.state.grossAmt - this.state.disAmt
										)}
									</strong>
								</td>
							</tr>
							...
							<tr>
								...
								<td className="bold">
									<strong>
										{" "}
										₹{this.roundOffTheNumber(this.state.totalAmt)}
									</strong>
								</td>
							</tr>
							...
							<tr>
								...
								<td className="bold">
									<strong>
										{this.roundOffTheNumber(this.state.mainAmnt) -
											Math.floor(this.state.mainAmnt) >
										0.5
											? `(+) ${(
													this.roundOffTheNumber(this.state.mainAmnt) -
													Math.floor(this.state.mainAmnt)
							...
							<tr>
								...
								<td className="bold">
									<strong>
										₹{this.roundOffTheNumber(this.state.mainAmnt.toFixed())}
									</strong>
								</td>
							</tr>
						</table>
                  ...
                  >
                    ...
                    <option> No G.R. Less </option>
								...
								<button
									onClick={(e) => {
										let a = {
											type: document.getElementById("add_dis_discount_type")
												.value,
											value: document.getElementById("add_discount_input")
												.value,
										};
										if (a.value === "") {
											return;
							...
							<div className="add_freight_con">
								...
								<div className="add_fre_btn_con">
									...
									<button
										...
										onClick={() => {
											let a = {
												remark: document.getElementById(
													"add_freight_remark_input"
												).value,
												value: document.getElementById("add_freight_input")
													.value,
											};
											if (a.value === "") {
												return;
